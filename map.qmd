...
<div style='font-family:sans-serif; font-size:13px; max-width:300px;'>
  ...
  <strong>Civic Opportunity Index (1–5 scale)</strong><br/>
{index_boxes}
  ...
  <div style='margin-bottom:4px;'>Volunteer
    <div style='background:#eee; width:100%; height:10px; position:relative;'>
      <div style='background:#1f77b4; width:{row$volunteer_sum}px; max-width:100%; height:10px;'></div>
      <div style='position:absolute; right:0; top:0; font-size:11px;'>{row$volunteer_sum}</div>
    </div>
  </div>
  <div style='margin-bottom:4px;'>Membership
    <div style='background:#eee; width:100%; height:10px; position:relative;'>
      <div style='background:#ff7f0e; width:{row$membership_sum}px; max-width:100%; height:10px;'></div>
      <div style='position:absolute; right:0; top:0; font-size:11px;'>{row$membership_sum}</div>
    </div>
  </div>
  <div style='margin-bottom:4px;'>Take Action
    <div style='background:#eee; width:100%; height:10px; position:relative;'>
      <div style='background:#2ca02c; width:{row$take_action_sum}px; max-width:100%; height:10px;'></div>
  ...
  <div style='margin-bottom:4px;'>Public Events
    <div style='background:#eee; width:100%; height:10px; position:relative;'>
      <div style='background:#d62728; width:{row$events_sum}px; max-width:100%; height:10px;'></div>
...
composition_bars <- function(df) {
  v_pct <- round(df$volunteer_sum / df$civic_org_sum * 100, 1)
  m_pct <- round(df$membership_sum / df$civic_org_sum * 100, 1)
  t_pct <- round(df$take_action_sum / df$civic_org_sum * 100, 1)
  e_pct <- round(df$events_sum / df$civic_org_sum * 100, 1)

  glue::glue("
  <div style='margin-top:6px;'>
    <strong>Civic Opportunity Composition</strong><br/>
    <div style='margin-bottom:4px;'>Volunteer
      <div style='background:#eee; width:100%; height:10px; position:relative;'>
        <div style='background:#1f77b4; width:{v_pct}%; height:10px;'></div>
        <div style='position:absolute; right:0; top:0; font-size:11px;'>{v_pct}%</div>
      </div>
    </div>
    <div style='margin-bottom:4px;'>Membership
      <div style='background:#eee; width:100%; height:10px; position:relative;'>
        <div style='background:#ff7f0e; width:{m_pct}%; height:10px;'></div>
        <div style='position:absolute; right:0; top:0; font-size:11px;'>{m_pct}%</div>
      </div>
    </div>
    <div style='margin-bottom:4px;'>Take Action
      <div style='background:#eee; width:100%; height:10px; position:relative;'>
        <div style='background:#2ca02c; width:{t_pct}%; height:10px;'></div>
        <div style='position:absolute; right:0; top:0; font-size:11px;'>{t_pct}%</div>
      </div>
    </div>
    <div style='margin-bottom:4px;'>Public Events
      <div style='background:#eee; width:100%; height:10px; position:relative;'>
        <div style='background:#d62728; width:{e_pct}%; height:10px;'></div>
        <div style='position:absolute; right:0; top:0; font-size:11px;'>{e_pct}%</div>
      </div>
    </div>
  </div>
  ")
...
htmltools::browsable(
  htmltools::tagList(
    tags$style(HTML("#map-container, #popup-sidebar {
  height: 50vh;
  width: 100%;
}
