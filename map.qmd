...
::: {.callout-warning collapse=true title="Interpreting the Primary Organization Type Map"}
...
- If a county has **no organizations of a specific type** (e.g., Religious), it will **not be colored for that type**.
- However, the county will still appear on the map if it has other types of civic opportunity organizations.
- If a county has **no civic opportunity organizations at all**, it will appear **gray** or may be excluded depending on the layer.
